...
def check_missing_flags(args):
    ...
    if not args.password:
        error_messages.append("Error: --password flag is required.")
    if not args.service:
...
parser.add_argument('--email', required=False, help="The email address to store (e.g., 'your_email@gmail.com').")
parser.add_argument('--password', required=False, help="The password to store. Use an app-specific password if using two-factor authentication.")
...
keyring.set_password(args.service, "email_password", args.password)
